...
public class ItemRegister {
    ...
    //PaNini
    public static final RegistryObject<Item> BaconPaNini = register(()-> Itemlist.food(7,7,false,false,true), "bacon_panini");
    public static final RegistryObject<Item> ChickenPaNini = register(()-> Itemlist.food(7,7,false,false,true), "chicken_panini");
    public static final RegistryObject<Item> BeefPaNini = register(()-> Itemlist.food(7,7,false,false,true), "beef_panini");
    public static final RegistryObject<Item> PorkPaNini = register(()-> Itemlist.food(7,7,false,false,true), "pork_panini");
    ...
    public static final RegistryObject<Item> ChickPorkBurger = register(()-> Itemlist.food(7,7,false,false,true), "cp_burger");
